    		...
    		$.ajax({
				...
				success: function(data){
					 if("-1" == data.code){
                        ...
                        //设置图片的url
                        $('#logo').attr('src', 'http://localhost:8080/pic/'+data.data.logo);
                        $('#idcardimage').attr('src', 'http://localhost:8080/pic/'+data.data.idcardimage);
                        $('#companyimage').attr('src', 'http://localhost:8080/pic/'+data.data.companyimage);
                        ...
                        <div class="col-sm-12">
                            ...
                            <form role="form" class="form-horizontal" method="post" enctype="multipart/form-data"  action="${pageContext.request.contextPath}/sysadmin/updateCompany" >
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-1">
	                                    <img src="" class="img-responsive" style="height:40px;width:40px;" alt="Responsive image" id="logo">
	                                </div>
	                                <div class="col-sm-3">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-1">
	                                    <img src="" id="idcardimage" class="img-responsive" style="height:40px;width:40px;" alt="Responsive image">
	                                </div>
	                                <div class="col-sm-3">
	                                ...
	                                <div class="col-sm-1">
	                                    <img id="companyimage" class="img-responsive" style="height:40px;width:40px;" alt="Responsive image">
	                                </div>
	                                <div class="col-sm-3">
