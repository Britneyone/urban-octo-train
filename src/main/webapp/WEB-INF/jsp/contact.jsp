   ...
   <div class="zhiweisousuo bodertop selectmod zx_aboutus"> 
    ...
    <div class="s_detail"> 
     <div class="about adminarea" id="ctlArticleShow"> 
      ...
      <br/>
      <p class="m_b10 unreset"><span style="font-size: medium;"><strong>1. 客服电话：</strong>  13631785646 (09:00-22:30)</span></p> 
      <p class="m_b10 unreset"><span style="font-size: medium;"><strong>2. 公司电话：</strong>（东莞）：13631785646 （上海）021-31125901</span></p> 
      <p class="m_b10 unreset"><span style="font-size: medium;"><strong>3. 公司地址：</strong>（总部）东莞理工学院大学路一号  邮编：523000 <span lang="EN-US">14</span>号楼<span lang="EN-US">415</span></span>&nbsp;</span></p> 
      <p class="m_b10 unreset"><span style="font-size: medium;"><strong>4. 官方微博：</strong> 924155240@qq.com（新浪微博）</span></p> 
      <p class="m_b10 unreset"><span style="font-size: medium;"><strong>5. 官方微信：</strong> H924155240</span></p> 
     </div> 
    </div> 
   </div> 
  </div> 
