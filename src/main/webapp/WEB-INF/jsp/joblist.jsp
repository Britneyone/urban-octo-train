...
<!-- 				福建省：福州市 厦门市 泉州市 漳州市 南平市 三明市 龙岩市 莆田市 宁德市 建瓯市 武夷山市 长乐市福清市 晋江市 南安市 福安市 龙海市 邵武市 石狮市 福鼎市 建阳市 漳平市 永安市  -->
         ...
         <select class="dropdown" id="type" name="type" tableindex="12">
          ...
          <input type="text" class="serchinput" maxlength="50" id="datalist" name="datalist" value="${requestScope.datalist }" style="height:35px;line-heitht:35px;font-size:15px;border-right:1px solid #D3D3D3;" placeholder="搜索职位 公司 （多个关键字，建议空格分隔） 例如 java 小郑"/>
